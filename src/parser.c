...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 1:
      ...
      if (set_contains(sym_string_character_set_2, 801, lookahead)) ADVANCE(1);
      END_STATE();
    case 2:
    ...
    case 4:
      ...
      END_STATE();
    case 5:
      if (set_contains(sym_string_character_set_1, 685, lookahead)) ADVANCE(1);
      END_STATE();
    case 6:
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [13] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_document_repeat1, 2, 0, 0), SHIFT_REPEAT(5),
